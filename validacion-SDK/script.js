...
function guardarDatos() {
  ...
  var QBD = document.getElementById("Query-Buider-debit").files[0];
  var QBC = document.getElementById("Query-Buider-credit").files[0];
  //obtener fecha actual
  var FechaActual = new Date();

  //obtengo el logotipo
  var logotipo = document.getElementById("logotipo-imagen").files[0];
  ...
  zip.file(logotipo.name + " - (" + codigoComercio + ")", logotipo, { base64: true });
  //en esta linea se agrega la imagen conocida como "Query Buider Debit" y entre parentecis se le añade el codigo de comercio
  zip.file("Query Buider Debit (" + codigoComercio + ").png", QBD, { base64: true });
  //en esta linea se agrega la imagen conocida como "Query Buider Credit" y entre parentecis se le añade el codigo de comercio
  zip.file("Query Buider Credit (" + codigoComercio + ").png", QBC, { base64: true });

  //formato de nombre archivo .zip
  var nombreArchivoZip = fechaFormateada + " - (" + codigoComercio + ") - "+ nombreecomer + " (SDK).zip";
...
function clearfill() { 
  ...
  //en esata seccion se limpia el input de tipo "file"
  ...
  document.getElementById("Query-Buider-debit").value = " ";
  document.getElementById("Query-Buider-credit").value = " ";
